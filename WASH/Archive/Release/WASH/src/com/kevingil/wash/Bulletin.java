...
public class Bulletin extends Activity {
	...
	void setUpBulletinWebView(){
        ...
        mWebViewProgress = ProgressDialog.show(this, "loading...", "optimizing for mobile", true);
        
        mWebView.loadUrl("https://gwhs-sfusd-ca.schoolloop.com/bulletin");
    ...
    void setUpSlideList(){
        ...
        mListView = (ListView)findViewById(R.id.slide_menu_main);
